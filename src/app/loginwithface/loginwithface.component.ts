...
export class LoginwithfaceComponent implements OnInit {
  ...
  constructor( private store: AngularFireStorage , private dataService: DataService ,private dataVerify: CompareService, public router:Router ,db: AngularFireDatabase) {
